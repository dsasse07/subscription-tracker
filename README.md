...
- [Using the App](#using-the-app)
  ...
  - [App Features](#app-features)
    - [My Subscriptions](#my-subscriptions)
      ...
      - [Add New Subscriptions](#adding-new-subscriptions)
      - [Update Subscription](#update-subscription)
      - [Delete Subscription](#delete-subscription)
      - [Access Reminders](#access-reminders)
    - [Spending Analyzer](#spending-analyzer)
      - [Overall Spending](#overall-spending-summary)
      - [By Category](#spending-by-category)
      - [Most Expensive](#most-expensive-subscription)
    - [Reminders](#reminders)
      - [Change Notice](#change-days-notice)
      - [Disable Reminder](#disable-reminder)
    - [User Settings](#user-settings)
      - [Change Username](#change-subscriptiontracker-username)
      - [Change Password](#change-subscriptiontracker-password)
      - [Update Budget](#update-budget)
      - [Delete Account](#delete-subscriptiontracker-account)
- [App Design](#app-design)
  ...
  - [Stetch Goals](#stetch-goals)
    ...
    - [User Login](#user-login-system)
    - [Modularization](#modularize-main-app)
    - [Calendar Sync](#reminders-link-to-users-calendar-app)
